...
export const applyComment = (data) => {
  ...
  //   });
  // });
  return http.post("/api/comment/apply", data)
};
...
export const deleteComment = (id, parent_id = 0) => {
  ...
  //   });
  // });
  return http.delete(`/api/comment/delete/${id}/${parent_id}`)
};
...
export const frontGetParentComment = (data) => {
  ...
  //   });
  // });
  return http.post("/api/comment/frontGetParentComment", data)
};
...
export const frontGetChildrenComment = (data) => {
  ...
  //   });
  // });
  return http.post("/api/comment/frontGetChildrenComment", data)
};
...
export const frontGetCommentTotal = (data) => {
  ...
  //   });
  // });
  return http.post("/api/comment/getCommentTotal", data)
};
