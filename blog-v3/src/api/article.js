...
export const homeGetArticleList = (current, size) => {
  ...
  // });
  return http.get(`/api/article/blogHomeGetArticleList/${current}/${size}`)
};
...
export const blogTimelineGetArticleList = (current, size) => {
  ...
  //   });
  // });
  return http.get(`/api/article/blogTimelineGetArticleList/${current}/${size}`)
};
...
export const getArticleListByTagId = (params) => {
  ...
  //   });
  // });
  return http.post("/api/article/getArticleListByTagId", params)
};
...
export const getArticleListByCategoryId = (params) => {
  ...
  //   });
  // });
  return http.post("/api/article/getArticleListByCategoryId", params)
};
...
export const getRecommendArticleById = (id) => {
  ...
  //   });
  // });
  return http.get(`/api/article/getRecommendArticleById/${id}`)
};
...
export const getArticleById = (id) => {
  ...
  //   });
  // });
  return http.get(`/api/article/getArticleById/${id}`)
};
...
export const getHotArticle = () => {
  ...
  //   });
  // });
  return http.get("/api/article/getHotArticle")
};
...
export const getArticleByContent = (content) => {
  ...
  //   });
  // });
  return http.get("/api/article/getArticleListByContent/" + content)
};
...
export const readingDuration = (id, duration) => {
  ...
  //   });
  // });
  return http.put(`/api/article/addReadingDuration/${id}/${duration}`)
};
